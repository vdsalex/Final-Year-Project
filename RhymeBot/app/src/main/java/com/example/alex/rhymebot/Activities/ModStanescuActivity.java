...
public class ModStanescuActivity extends AppCompatActivity
{
        ...
        activateButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(!activateButtonPressed)
                {
                    ...
                    activateButton.setText("Dezactivează");
                    ...
                    Toast.makeText(getApplicationContext(), "Modul Stănescu a fost activat!", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    Toast.makeText(getApplicationContext(), "Modul Stănescu a fost dezactivat!", Toast.LENGTH_SHORT).show();
                }
    ...
    {
        activateButton.setTextColor(Color.parseColor("#4e4e50")); //gold
        activateButton.setBackground(background_pressed);
